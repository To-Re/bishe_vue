<template>
  <div class="login-container">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="login">返回</el-button>
...
export default {
  data() {
    ...
    return {
      ...
      registerRules: {
        number: [{ required: true, trigger: 'blur', validator: validateUserNumber }],
  ...
  methods: {
    ...
    handleregister() {
        register({
            number: this.registerForm.number.trim(),
